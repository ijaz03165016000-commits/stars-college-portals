...
const guard = (fn) => async (ctx) => {
  if (!current) { ctx.el.innerHTML = `<div class="card2"><h3>No children linked yet</h3><p class="muted">Ask the college office to link your children to this parent account.</p></div>`; return; }
  return fn(ctx);
};
